...
def main(path_image, path_save):
    ...
    model = model.load_weight(r"C:\Users\Admin\PycharmProjects\bassso4isme2023\function\gen_00065000.pt")
    model = model.cuda()
    model.eval()

    #Input image;
    image = preprocessing_image(path_image)
    ...
    #Path file;
    image_org = os.path.join(path_save, "image_org.PNG")
    image_mask = os.path.join(path_save, "image_mask.PNG")
    image_res = os.path.join(path_save, "image_res.PNG")
    #Save image;
...
main(r"C:\Users\Admin\PycharmProjects\bassso4isme2023\function\static\test.png", r"C:\Users\Admin\PycharmProjects\bassso4isme2023\function\static")